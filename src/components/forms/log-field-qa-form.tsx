...
export function LogFieldQAForm({
  open,
  onOpenChange,
  request,
  onSubmit,
    ...
    <Modal open={open} onOpenChange={onOpenChange}>
      <ModalContent>
        <form onSubmit={handleSubmit}>
          <ModalHeader title="Field QA" onClose={() => onOpenChange(false)} />
          <ModalBody>
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-[14px] leading-[20px] text-[#525C4E]">
                  Scheduled visit: {request.scheduledDate} <span className="font-bold">•</span> {request.assignedTo} <span className="font-bold">•</span> {summary.warehouse}
                </p>
              </div>

              {/* Form fields */}
              <div className="flex flex-col gap-4">
                {/* Visual grade + Moisture row */}
                ...
                {/* Notes / Observations with char count */}
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-wrap items-start gap-3">
                    ...
                    <button
                      ...
                      className="w-[109px] h-[109px] rounded-[16px] outline outline-1 outline-[#73796E] bg-white flex items-center justify-center hover:bg-[#F7FAF6] transition-colors"
                    >
          ...
          <ModalFooter className="justify-end">
            <Button type="submit" size="md" shape="rect" disabled={!canSubmit}>Save QA Result</Button>
          </ModalFooter>
        </form>
      </ModalContent>
    </Modal>
